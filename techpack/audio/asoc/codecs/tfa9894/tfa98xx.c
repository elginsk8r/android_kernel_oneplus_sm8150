/*
 * tfa98xx.c   tfa98xx snd_soc_register_component module
 *
...
static int snd_soc_register_component_is_dummy = 0;
...
static void tfa98xx_container_loaded(const struct firmware *cont, void *context)
{
	...
	*/
	...
	if ((tfa98xx->tfa->dev_idx==0) || ((tfa98xx->tfa->dev_idx==1) && snd_soc_register_component_is_dummy)) {
		snd_soc_register_component_is_dummy = 0;
			     ...
			     const struct i2c_device_id *id)
{
	...
	if ((no_start == 0) && (no_reset == 0)) {
		...
		if (ret < 0) {
			dummy = 1;
			snd_soc_register_component_is_dummy = 1;
...
//			return -EIO;
			goto register_snd_soc_register_component;
		}
		switch (reg & 0xff) {
		case 0x72: /* tfa9872 */
	 ...
	 */
register_snd_soc_register_component:
	if(dummy) {
