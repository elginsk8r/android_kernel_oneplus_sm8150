...
static void wcd_mbhc_usbc_analog_plug_detect_handler(struct wcd_mbhc *mbhc, bool detection_type)
{
	...
	if ((mbhc->current_plug == MBHC_PLUG_TYPE_NONE) &&
		...
		if (mbhc->mbhc_cfg->enable_usbc_analog) {
			struct snd_soc_component *component = mbhc->component;
			int val = 0;
			val = wcd_mbhc_component_read(component, WCD934X_CDC_TX_INP_MUX_ADC_MUX0_CFG0) & 0x03;
			...
			} else if ((wcd_mbhc_component_read(component, WCD934X_CDC_TX_INP_MUX_ADC_MUX1_CFG0) & 0x03) == 2) {
